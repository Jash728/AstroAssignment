This project is a web application for managing astrologer information. It allows users to view a list of astrologers, edit their details, and add new astrologers. 
